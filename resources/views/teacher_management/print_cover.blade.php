            ...
            <div class="group">
                <table>
                    <tbody>
                        ...
                        {{-- 10.--}} <tr> <td> 10.      </td> <td colspan="2"> Sekolah Asal (SD/MI) </td>                   <td> : </td><td> {{ $report->student->user->name }} </td> </tr>
                        {{-- 11.--}} <tr> <td> 11.      </td> <td colspan="2"> Diterima di SMP ini </td>                    <td> </td><td> </td> </tr>
                        {{-- __A--}} <tr> <td> {{----}} </td> <td            > a. </td> <td> Di Kelas </td> <td> : </td> <td></td> </tr>
                        {{-- __B--}} <tr> <td> {{----}} </td> <td            > b. </td> <td> Pada Tanggal </td> <td> : </td> <td></td> </tr>
                        ...
                        {{-- __D--}} <tr> <td> {{----}} </td> <td            > d. </td> <td> Nomor Telp/HP </td> <td> : </td> <td> {{ $report->student->father_name }} </td> </tr>
                        ...
                        {{-- __B--}} <tr> <td> {{----}} </td> <td            > b. </td> <td> No Telp/HP </td> <td> : </td> <td> {{ $report->student->guardian_name }} </td> </tr>
